...
- 修改 launcher/runtime 组合后，从仓库外临时业务 Git 项目验证 cwd/argv、五 extensions（Qoder 默认 inert / opt-in）、一个 skill、无 bundled templates 和 Claude Skill bridge。
