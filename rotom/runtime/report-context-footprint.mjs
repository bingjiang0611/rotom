...
export const CURRENT_RUNTIME_CONTEXT_CONTRACT_V1 = {
	...
	// real SDK smoke, including Relay text/role query metadata, readback deltas,
	// and the corrected ref-bound focus contract; static bytes are not provider tokens.
	activeToolCount: 23,
	activeToolSchemaBytes: 20_632,
...
export const FULL_TOOL_CONTEXT_CONTRACT_V1 = {
	activeToolCount: 24,
	activeToolSchemaBytes: 35_286,
	activeToolGuidelineBytes: 10_892,
...
export const SCOPED_FULL_TOOL_CONTEXT_CONTRACT_V1 = {
	...
	activeToolSchemaBytes: 36_547,
	activeToolGuidelineBytes: 11_385,
