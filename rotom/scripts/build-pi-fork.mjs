...
async function buildFork() {
	...
	try {
		...
		console.log(run(["test", "--", "test/model-selector.test.ts", "test/scoped-models-selector.test.ts", "test/suite/agent-session-model-extension.test.ts", "test/suite/regressions/3217-scoped-model-order.test.ts", "test/suite/regressions/7209-model-selector-filter-resets-selection.test.ts", "test/suite/regressions/7153-scoped-models-refresh.test.ts", "test/compaction.test.ts", "test/rotom-startup.test.ts", "test/interactive-mode-status.test.ts", "test/suite/regressions/5943-session-start-notify.test.ts", "test/rotom-product.test.ts", "test/version-check.test.ts", "test/interactive-mode-startup-input.test.ts"], resolve(tree, "packages/coding-agent")));
		const names = new Map();
